            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="item.subMenu.label" default="Sub Menu" /></td>
                            
                            <td valign="top" class="value"><g:link controller="subMenu" action="show" id="${itemInstance?.subMenu?.id}">${itemInstance?.subMenu?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="item.backGroundColor.label" default="Back Ground Color" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: itemInstance, field: "backGroundColor")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="item.backGroundPicture.label" default="Back Ground Picture" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: itemInstance, field: "backGroundPicture")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="item.font.label" default="Font" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: itemInstance, field: "font")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="item.fontColor.label" default="Font Color" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: itemInstance, field: "fontColor")}</td>
