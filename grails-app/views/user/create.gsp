                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label><g:message code="user.retypePassword.label" default="" /></label>
                                </td>
                                <td valign="top">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'admin', 'errors')}">
                                    <g:select name="admin.id" from="${menu.manager.Admin.list()}" optionKey="id" value="${userInstance?.admin?.id}"  />
                                </td>
                            </tr>
